...
./formatmapdata.sh ./map/WorldOfWarcraftReforged-ClassesOverview.txt ./classes-overview.html &
...
./formatmapdata.sh ./map/WorldOfWarcraftReforged-ProfessionsOverview.txt ./professions-overview.html &
